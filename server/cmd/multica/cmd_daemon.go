...
func init() {
	...
	f.String("workspaces-root", "", "Workspaces root path (env: MULTICA_WORKSPACES_ROOT, config: workspaces_root)")
	f.String("codex-home", "", "Shared Codex home used to seed per-task CODEX_HOME (env: CODEX_HOME, config: codex_home)")
	...
	rf.String("workspaces-root", "", "Workspaces root path (env: MULTICA_WORKSPACES_ROOT, config: workspaces_root)")
	rf.String("codex-home", "", "Shared Codex home used to seed per-task CODEX_HOME (env: CODEX_HOME, config: codex_home)")
