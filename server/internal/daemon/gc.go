...
func (d *Daemon) runGC(ctx context.Context) {
	...
	if storesRemoved, storeBytes := execenv.PruneCodexSessionStoresAt(d.cfg.SharedCodexHome, d.cfg.Profile, d.cfg.GCCodexSessionTTL, time.Now(), d.reserveCodexStoreForDeletion, d.logger); storesRemoved > 0 {
